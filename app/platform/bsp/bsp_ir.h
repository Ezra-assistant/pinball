...
u8 get_irkey(void);
void ir_switch_clk(u8 ch);  //0:关闭时钟  1:x24m_div_clk  2:osc32k  3:rc32k_clk
void ir_update_errcnt(u8 type);//0:默认参数 1:内部32k参数
void ir_update_errcnt_do(u8 type); //0:默认参数 1:使用ir_update_errcnt更新的参数
#endif // _BSP_IR_H
