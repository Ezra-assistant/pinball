...
AT(.text.bsp.param)
u32 param_lsbc_break_addr_read(void)
{
    u32 break_addr = 0;
    param_read((u32 *)&break_addr, PARAM_RES_BREAK_ADDR, 4);
    return break_addr;
...
AT(.text.bsp.param)
void param_lsbc_break_addr_write(u32 break_addr)
{
    param_write((u32 *)&break_addr, PARAM_RES_BREAK_ADDR, 4);
}

AT(.text.bsp.param)
u32 param_lsbc_break_pos_read(void)
{
    u32 break_pos = 0;
    param_read((u32 *)&break_pos, PARAM_RES_BREAK_POS, 4);
    return break_pos;
...
AT(.text.bsp.param)
void param_lsbc_break_pos_write(u32 break_pos)
{
    param_write((u32 *)&break_pos, PARAM_RES_BREAK_POS, 4);
}
#endif
...
AT(.text.bsp.param)
u32 param_midi_break_addr_read(void)
{
    u32 break_addr = 0;
    param_read((u32 *)&break_addr, PARAM_RES_MIDI_ADDR, 4);
    return break_addr;
}

AT(.text.bsp.param)
void param_midi_break_addr_write(u32 break_addr)
{
    param_write((u32 *)&break_addr, PARAM_RES_MIDI_ADDR, 4);
}

AT(.text.bsp.param)
u32 param_midi_break_pos_read(void)
{
    u32 break_pos = 0;
    param_read((u32 *)&break_pos, PARAM_RES_MIDI_POS, 4);
    return break_pos;
}

AT(.text.bsp.param)
void param_midi_break_pos_write(u32 break_pos)
{
    param_write((u32 *)&break_pos, PARAM_RES_MIDI_POS, 4);
}
#endif
